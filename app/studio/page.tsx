        ...
        <div className="max-w-3xl mx-auto">
                ...
                >
                  <header className="flex flex-wrap items-baseline justify-between gap-3 mb-3">
                    <div className="flex items-baseline gap-3">
                      ...
                      <span className="text-sm mono text-[--color-mute]">
                        {p.role}
                      </span>
                    </div>
                  ...
                  <p className="text-base text-[--color-paper] font-medium mb-3">
                    {p.tagline}
                  </p>
                  <p className="text-sm text-[--color-paper]/85 leading-relaxed mb-4">
                    {p.bio}
                  </p>
                  <blockquote
                    className={`border-l-2 ${
                      p.accent === "gold"
                        ? "border-[--color-gold]"
                        : "border-[--color-rust]"
                    } pl-4 my-4 italic text-[--color-paper]/90`}
                  >
                    &ldquo;{p.quote}&rdquo;
                  </blockquote>
          ...
          <div className="card rounded-xl p-6 sm:p-8 mt-10">
            ...
            <p className="text-sm text-[--color-paper]/85 leading-relaxed">
              ...
              processing is{" "}
              <span className="text-[--color-paper]">Rob Matthews</span>, the
